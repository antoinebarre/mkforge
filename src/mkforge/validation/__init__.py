...
contracts such as required YAML frontmatter, chapter order, and image
reachability.  This is separate from Markdown/GFM verification, which checks
syntax and compliance rules.
"""
